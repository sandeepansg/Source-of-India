...
\newcommand{\soiConstitutionTerm}[1]{\textsc{#1}}
\newcommand{\soiActCitation}[1]{\textit{#1}}

%% Header customization
\newcommand{\soiHeaderFont}{\small\itshape}
...
\newcommand{\soiConstitutionTitle}{THE CONSTITUTION OF INDIA}
\newcommand{\soiConstitutionSubtitle}{As amended up to the One Hundred and Fifth Amendment Act, 2021}
\newcommand{\soiConstitutionDate}{26th November, 1949}

%% Amendment citation formatting
\newcommand{\soiAmendmentCite}[2]{%
    Constitution (#1 Amendment) Act, #2%
}

%% Effective date formatting
\newcommand{\soiEffectiveDate}[1]{%
    \textit{w.e.f.} #1%
}
...
\newcommand{\soiArtRef}[1]{Article~\ref{art:#1}}
\newcommand{\soiPartRef}[1]{Part~\ref{part:#1}}
\newcommand{\soiSchedRef}[1]{Schedule~\ref{sched:#1}}

%% Special constitutional formatting
\newcommand{\soiPreambleFormat}{\centering\large\itshape}
\newcommand{\soiSignatureFormat}{\raggedleft\normalsize}
